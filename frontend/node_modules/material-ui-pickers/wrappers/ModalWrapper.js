  ...
  (0, _createClass3.default)(ModalWrapper, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          other = (0, _objectWithoutProperties3.default)(_props, ['value', 'format', 'children', 'dialogContentClassName', 'onAccept', 'onDismiss', 'invalidLabel', 'labelFunc', 'okLabel', 'cancelLabel', 'clearLabel', 'clearable', 'todayLabel', 'showTodayButton', 'onOpen', 'onClose', 'onSetToday', 'isAccepted']);
...
ModalWrapper.propTypes = {
  ...
  /** Format string */
  invalidLabel: _propTypes2.default.node,
  ...
  /** "Clear" label message */
  clearLabel: _propTypes2.default.node,
  ...
  */
  ...
  isAccepted: _propTypes2.default.bool.isRequired
};
