...
var SecondsView = exports.SecondsView = function (_Component) {
  (0, _inherits3.default)(SecondsView, _Component);
  ...
  function SecondsView() {
    ...
    (0, _classCallCheck3.default)(this, SecondsView);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = SecondsView.__proto__ || (0, _getPrototypeOf2.default)(SecondsView)).call.apply(_ref, [this].concat(args))), _this), _this.handleChange = function (seconds, isFinish) {
  ...
  (0, _createClass3.default)(SecondsView, [{
    key: 'render',
...
exports.default = (0, _WithUtils2.default)()(SecondsView);